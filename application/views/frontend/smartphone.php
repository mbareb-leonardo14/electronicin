...
<html lang="en">
    ...
    <body>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="<?php echo base_url()?>index.php/smartphone">Smartphone</a></li>
                    ...
                    <form class="d-flex">
                        ...
                        <a href="<?php echo base_url()?>index.php/home/keranjang" class="nav-link text-dark">
        ...
        style="background-color: #25D366; border-radius: 50%; position: fixed; right:50px; top:150px"
        href="#!"
        role="button"
