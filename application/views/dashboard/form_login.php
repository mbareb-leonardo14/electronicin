               ...
               <div class="col-lg-4 mx-auto">
                ...
                <img src="../../images/logo.svg" alt="logo">
                     ...
                     <form method="POST" action="<?php echo site_url('login/aksi_login'); ?>"
                        class="needs-validation pt-3" novalidate="">
                        ...
                        <div class="mt-3">
                           <a class="btn btn-primary text-white" href="<?= site_url('Adminpanel/statistik') ?>">SIGN
                              IN</a>
                        </div>
                  ...
                  <button type="button" class="btn btn-block btn-facebook auth-form-btn">
                    <i class="mdi mdi-facebook me-2"></i>Connect using facebook
                        ...
                        <div class="text-center mt-4 font-weight-light">
                           Don't have an account? <a href="<?= base_url('adminpanel/register'); ?>"
