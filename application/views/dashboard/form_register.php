               ...
               <div class="col-lg-4 mx-auto">
                  <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                     <div class="brand-logo">
                        <img src="<?= base_url('assets/majestic/') ?>images/logo.svg" alt="logo">
                     </div>
                     <h4>New here?</h4>
                     ...
                     <form class="pt-3">
                        ...
                        <div class="mt-3">
                           <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn text-white"
                              href="../../index.html">SIGN UP</a>
                        </div>
                        <div class="text-center mt-4 font-weight-light">
                           Already have an account? <a href="<?= base_url('adminpanel'); ?>"
