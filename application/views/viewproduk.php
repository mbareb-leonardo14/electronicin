        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../assets/img/Computer.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: BST-498</div>
                        <h1 class="display-5 fw-bolder">Samsung Computer</h1>
                        <div class="fs-5 mb-5">
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <li class="nav-item" role="presentation">
                 <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Description Product</button>
                 </li>
                <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Review Product</button>
                </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium at dolorem quidem modi. Nam sequi consequatur obcaecati excepturi alias magni, accusamus eius blanditiis delectus ipsam minima ea iste laborum vero?</div>

                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="row mt-3">
                        <div class="row">
                            <div class="col-1">
                                <img src="<?php echo base_url() ?>assets/img/pawat.jpg" class="rounded-circle w-100">
                            </div>
                            <div class="col-11">
                                <p class="mb-0"> Ohm Pawat</p>
                                ...
                                <p class="mt-2"> Computernya bagus, pacar saya suka. Bintang 5 untuk penjualnya</p>

                                <div class="row">
                                    <div class="col-2"><img src="<?php echo base_url() ?>assets/img/computer.jpg" class="w-100"></div>
                                    <div class="col-2"><img src="<?php echo base_url() ?>assets/img/ohmnon.jpg" class="w-100"></div>
                                </div>
