...
<html lang="en">
    ...
    <body>
        ...
        <section class="py-5">
            <div class="container">
                <h3>Silahkan isi dengan lengkap dan jelas </h3>
            <form method="POST" action="<?php echo base_url() ?>index.php/dashboard/prosespesanan">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nohp" placeholder="No HP Anda..." class="form-control">
                </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn btn-sm btn-primary">Pesan</button>
            </form>
            </div>
